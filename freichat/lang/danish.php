...
//NOTE: &nbsp; is euivalent to a space 
    ...
    $frei_trans['g_prefix']          =          'G&aelig;st-';
    ...
    $frei_trans['titles_translate']     =       'Overs&aelig;t til dit eget sprog';
    $frei_trans['titles_clrcht']     =       'Ryd chat vindue historie';
    $frei_trans['titles_upload']        =       'Send fil';
    $frei_trans['titles_smiley']        =       'Inds&aelig;t smiley';
    ...
    $frei_trans['chat_status'] = 'Brugeren er ikke online, meddelsen bliver leveret n&aelig;ste gang brugeren kommer online. ';
    
    $frei_trans['rtl'] = 'Swicth rtl text';
    
    $frei_trans['profilelink'] = 'Vis profil';
    
    $frei_trans['ban_mesg'] = 'Du er sp&aelig;rret';
    
    $frei_trans['chatroom_label']=' &nbsp;&nbsp; ChatRum';
    $frei_trans['chatroom_noline']   =  'Du er den eneste der er online her';

    
    $frei_trans['no_search_results'] = 'Ingen s&oslash;ge resultat!';
    ...
    $frei_trans["mobile_file_title"] = "V&aelig;lg den fil du vil sende";
    
    $frei_trans["mobile_mail_title"] = "Send samtalen p&aring; email";
    ...
    $frei_trans["mobile_settings"] = "Ops&aelig;tning";
    $frei_trans["mobile_loading"] = "Indl&aelig;ser...";
    ...
    $frei_trans["fullscreen"] = "Fuld sk&aelig;rm";
    $frei_trans["textchat"] = "Tekst chat";
    
    $frei_trans["browser_unsupported"] = "Din internet browser underst&oslash;ttes ikke. Opdater venligst din internet browser";
    $frei_trans["onmediasuccess"] = "Adgang godkendt, Indl&aelig;ser video .....";
    ...
    $frei_trans["vid_wait_media"] = "Afventer at f&aring; adgang til kamara og microfon ";
    
    $frei_trans["vid_req_sent"] = "En video chat foresp&oslash;rgsel er blevet sendt";
    $frei_trans["vid_start_call"] = " Klik her for at starte video samtale";
    $frei_trans["vid_req_rec"] = "Dette er et video samtale &oslash;nske ";
    $frei_trans["vid_req_accept"] = "Videosamtale &oslash;nske acceptere"; 
